...
def wrap_connect(
    ...
    """
    db_api_integration_factory = db_api_integration_factory or DatabaseApiIntegration
    ...
    try:
        wrapt.wrap_function_wrapper(connect_module, connect_method_name, wrap_connect_)
